...
echo_and_run cd "/home/georg/rosplan_ws/src/ROSPlan/rosplan_action_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/georg/rosplan_ws/src/ROSPlan/rosplan_action_interface/setup.py" \
     \
    build --build-base "/home/georg/rosplan_ws/build/ROSPlan/rosplan_action_interface" \
    install \
    --root="${DESTDIR-/}" \
