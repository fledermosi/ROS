...
class KnowledgeUpdateServiceRequest(genpy.Message):
  ...
  _full_text = """# Knowledge building; service(1/1):
...
"""
    ...
    try:
      ...
      for val1 in self.knowledge.values:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.knowledge.function_value
      ...
      _x = self.knowledge.ineq.comparison_type
      ...
      for val1 in self.knowledge.ineq.RHS.tokens:
        ...
        _x = val1
        buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
      _x = self.knowledge.ineq.grounded
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.knowledge.instance_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.knowledge.instance_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.knowledge.attribute_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.knowledge.optimization = str[start:end].decode('utf-8', 'rosmsg')
      else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v10.name = str[start:end].decode('utf-8', 'rosmsg')
        else:
