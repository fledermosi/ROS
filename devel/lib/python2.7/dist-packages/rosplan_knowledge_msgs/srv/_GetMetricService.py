...
class GetMetricServiceRequest(genpy.Message):
  ...
  _full_text = """# PDDL problem generation; service(3/3):
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.metric.ineq.comparison_type
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.metric.instance_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.metric.instance_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.metric.attribute_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.metric.optimization = str[start:end].decode('utf-8', 'rosmsg')
      else:
