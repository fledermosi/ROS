...
class KnowledgeQueryServiceRequest(genpy.Message):
  _md5sum = "35f34b6a9859a67dd0f299bf065fb1c7"
  _type = "rosplan_knowledge_msgs/KnowledgeQueryServiceRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """rosplan_knowledge_msgs/KnowledgeItem[] knowledge
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.instance_type = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.instance_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.optimization = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v11.name = str[start:end].decode('utf-8', 'rosmsg')
          else:
        ...
        for i in range(0, length):
          ...
          if python3:
            _v14.name = str[start:end].decode('utf-8', 'rosmsg')
          else:
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v30.name = str[start:end].decode('utf-8', 'rosmsg')
          else:
...
class KnowledgeQueryServiceResponse(genpy.Message):
  _md5sum = "3a9313841904d965dc44153815f77b0d"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.Struct(pattern).pack(*self.results))
      length = len(self.false_knowledge)
      buff.write(_struct_I.pack(length))
      for val1 in self.false_knowledge:
        _x = val1.knowledge_type
        buff.write(_get_struct_B().pack(_x))
        _v33 = val1.initial_time
        _x = _v33
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = val1.is_negative
        buff.write(_get_struct_B().pack(_x))
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v34 = val1.expr
        length = len(_v34.tokens)
        buff.write(_struct_I.pack(length))
        for val3 in _v34.tokens:
          _x = val3
          buff.write(_get_struct_Bd().pack(_x.expr_type, _x.constant))
          _v35 = val3.function
          _x = _v35.name
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          length = len(_v35.typed_parameters)
          buff.write(_struct_I.pack(length))
          for val5 in _v35.typed_parameters:
            _x = val5.key
            length = len(_x)
            if python3 or type(_x) == unicode:
              _x = _x.encode('utf-8')
          ...
          buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
        _v36 = val1.ineq
        _x = _v36.comparison_type
        buff.write(_get_struct_B().pack(_x))
        _v37 = _v36.LHS
        length = len(_v37.tokens)
        buff.write(_struct_I.pack(length))
        for val4 in _v37.tokens:
          _x = val4
          buff.write(_get_struct_Bd().pack(_x.expr_type, _x.constant))
          _v38 = val4.function
          _x = _v38.name
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          length = len(_v38.typed_parameters)
          buff.write(_struct_I.pack(length))
          for val6 in _v38.typed_parameters:
            _x = val6.key
            length = len(_x)
            if python3 or type(_x) == unicode:
              _x = _x.encode('utf-8')
          ...
          buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
        _v39 = _v36.RHS
        length = len(_v39.tokens)
        buff.write(_struct_I.pack(length))
        for val4 in _v39.tokens:
          _x = val4
          buff.write(_get_struct_Bd().pack(_x.expr_type, _x.constant))
          _v40 = val4.function
          _x = _v40.name
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          length = len(_v40.typed_parameters)
          buff.write(_struct_I.pack(length))
          for val6 in _v40.typed_parameters:
            _x = val6.key
            length = len(_x)
            if python3 or type(_x) == unicode:
              _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.all_true,) = _get_struct_B().unpack(str[start:end])
      ...
      self.results = s.unpack(str[start:end])
      self.results = list(map(bool, self.results))
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.false_knowledge = []
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            if python3:
              ...
              val5.value = str[start:end]
            _v43.typed_parameters.append(val5)
          _x = val3
          start = end
          end += 2
          (_x.op, _x.special_type,) = _get_struct_2B().unpack(str[start:end])
          _v42.tokens.append(val3)
        _v44 = val1.ineq
        start = end
        end += 1
        (_v44.comparison_type,) = _get_struct_B().unpack(str[start:end])
        _v45 = _v44.LHS
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            if python3:
              ...
              val6.value = str[start:end]
            _v46.typed_parameters.append(val6)
          _x = val4
          start = end
          end += 2
          (_x.op, _x.special_type,) = _get_struct_2B().unpack(str[start:end])
          _v45.tokens.append(val4)
        _v47 = _v44.RHS
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v48.name = str[start:end].decode('utf-8', 'rosmsg')
          else:
            _v48.name = str[start:end]
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v48.typed_parameters = []
          for i in range(0, length):
            val6 = diagnostic_msgs.msg.KeyValue()
            start = end
            end += 4
            ...
            if python3:
              ...
              val6.value = str[start:end]
            _v48.typed_parameters.append(val6)
          _x = val4
          start = end
          end += 2
          (_x.op, _x.special_type,) = _get_struct_2B().unpack(str[start:end])
          _v47.tokens.append(val4)
        start = end
        end += 1
        (_v44.grounded,) = _get_struct_B().unpack(str[start:end])
        _v44.grounded = bool(_v44.grounded)
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.false_knowledge:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v50 = val1.expr
        length = len(_v50.tokens)
        buff.write(_struct_I.pack(length))
        for val3 in _v50.tokens:
          _x = val3
          buff.write(_get_struct_Bd().pack(_x.expr_type, _x.constant))
          _v51 = val3.function
          _x = _v51.name
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          length = len(_v51.typed_parameters)
          buff.write(_struct_I.pack(length))
          for val5 in _v51.typed_parameters:
            _x = val5.key
            length = len(_x)
            if python3 or type(_x) == unicode:
              _x = _x.encode('utf-8')
          ...
          buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
        _v52 = val1.ineq
        _x = _v52.comparison_type
        buff.write(_get_struct_B().pack(_x))
        _v53 = _v52.LHS
        length = len(_v53.tokens)
        buff.write(_struct_I.pack(length))
        for val4 in _v53.tokens:
          _x = val4
          buff.write(_get_struct_Bd().pack(_x.expr_type, _x.constant))
          _v54 = val4.function
          _x = _v54.name
          ...
          buff.write(_struct_I.pack(length))
          for val6 in _v54.typed_parameters:
            _x = val6.key
            length = len(_x)
            if python3 or type(_x) == unicode:
              _x = _x.encode('utf-8')
          ...
          buff.write(_get_struct_2B().pack(_x.op, _x.special_type))
        _v55 = _v52.RHS
        length = len(_v55.tokens)
        buff.write(_struct_I.pack(length))
        for val4 in _v55.tokens:
          _x = val4
          buff.write(_get_struct_Bd().pack(_x.expr_type, _x.constant))
          _v56 = val4.function
          _x = _v56.name
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          length = len(_v56.typed_parameters)
          buff.write(_struct_I.pack(length))
          for val6 in _v56.typed_parameters:
            _x = val6.key
            length = len(_x)
            if python3 or type(_x) == unicode:
              _x = _x.encode('utf-8')
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            if python3:
              ...
              val5.value = str[start:end]
            _v59.typed_parameters.append(val5)
          _x = val3
          start = end
          end += 2
          (_x.op, _x.special_type,) = _get_struct_2B().unpack(str[start:end])
          _v58.tokens.append(val3)
        _v60 = val1.ineq
        start = end
        end += 1
        (_v60.comparison_type,) = _get_struct_B().unpack(str[start:end])
        _v61 = _v60.LHS
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v62.name = str[start:end].decode('utf-8', 'rosmsg')
          else:
            _v62.name = str[start:end]
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v62.typed_parameters = []
          for i in range(0, length):
            val6 = diagnostic_msgs.msg.KeyValue()
            start = end
            end += 4
            ...
            if python3:
              ...
              val6.value = str[start:end]
            _v62.typed_parameters.append(val6)
          _x = val4
          start = end
          end += 2
          (_x.op, _x.special_type,) = _get_struct_2B().unpack(str[start:end])
          _v61.tokens.append(val4)
        _v63 = _v60.RHS
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v64.name = str[start:end].decode('utf-8', 'rosmsg')
          else:
            _v64.name = str[start:end]
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          _v64.typed_parameters = []
          for i in range(0, length):
            val6 = diagnostic_msgs.msg.KeyValue()
            start = end
            end += 4
            ...
            if python3:
              ...
              val6.value = str[start:end]
            _v64.typed_parameters.append(val6)
          _x = val4
          start = end
          end += 2
          (_x.op, _x.special_type,) = _get_struct_2B().unpack(str[start:end])
          _v63.tokens.append(val4)
        start = end
        end += 1
        (_v60.grounded,) = _get_struct_B().unpack(str[start:end])
        _v60.grounded = bool(_v60.grounded)
        self.false_knowledge.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class KnowledgeQueryService(object):
  ...
  _md5sum = 'e5cd9298f5a545040e7835836f3210cb'
