...
class DomainOperator(genpy.Message):
  _md5sum = "169396bd4c8278ca06550ef5a062c243"
  _type = "rosplan_knowledge_msgs/DomainOperator"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# A message used to represent an ungrounded operator in the domain.
...
bool grounded
"""
  __slots__ = ['formula','at_start_add_effects','at_start_del_effects','at_end_add_effects','at_end_del_effects','at_start_assign_effects','at_end_assign_effects','probabilistic_effects','at_start_simple_condition','over_all_simple_condition','at_end_simple_condition','at_start_neg_condition','over_all_neg_condition','at_end_neg_condition','at_start_comparison','at_end_comparison','over_all_comparison']
  _slot_types = ['rosplan_knowledge_msgs/DomainFormula','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainAssignment[]','rosplan_knowledge_msgs/DomainAssignment[]','rosplan_knowledge_msgs/ProbabilisticEffect[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainFormula[]','rosplan_knowledge_msgs/DomainInequality[]','rosplan_knowledge_msgs/DomainInequality[]','rosplan_knowledge_msgs/DomainInequality[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       formula,at_start_add_effects,at_start_del_effects,at_end_add_effects,at_end_del_effects,at_start_assign_effects,at_end_assign_effects,probabilistic_effects,at_start_simple_condition,over_all_simple_condition,at_end_simple_condition,at_start_neg_condition,over_all_neg_condition,at_end_neg_condition,at_start_comparison,at_end_comparison,over_all_comparison
    ...
    if args or kwds:
      ...
      if self.at_start_assign_effects is None:
        self.at_start_assign_effects = []
      if self.at_end_assign_effects is None:
        self.at_end_assign_effects = []
      if self.probabilistic_effects is None:
      ...
      if self.at_start_comparison is None:
        self.at_start_comparison = []
      if self.at_end_comparison is None:
        self.at_end_comparison = []
      if self.over_all_comparison is None:
        self.over_all_comparison = []
    else:
      self.formula = rosplan_knowledge_msgs.msg.DomainFormula()
      self.at_start_add_effects = []
      self.at_start_del_effects = []
      ...
      for val1 in self.at_end_del_effects:
        ...
        for val2 in val1.typed_parameters:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.at_start_assign_effects)
      buff.write(_struct_I.pack(length))
      for val1 in self.at_start_assign_effects:
        _x = val1.assign_type
        ...
        _x = val1.grounded
        buff.write(_get_struct_B().pack(_x))
      length = len(self.at_end_assign_effects)
      buff.write(_struct_I.pack(length))
      for val1 in self.at_end_assign_effects:
        _x = val1.assign_type
        buff.write(_get_struct_B().pack(_x))
        _v4 = val1.LHS
        _x = _v4.name
        ...
        _x = val1.grounded
        buff.write(_get_struct_B().pack(_x))
      length = len(self.probabilistic_effects)
      buff.write(_struct_I.pack(length))
      for val1 in self.probabilistic_effects:
      ...
      for val1 in self.at_end_neg_condition:
        ...
        for val2 in val1.typed_parameters:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.at_start_comparison)
      buff.write(_struct_I.pack(length))
      for val1 in self.at_start_comparison:
        ...
        _x = val1.grounded
        buff.write(_get_struct_B().pack(_x))
      length = len(self.at_end_comparison)
      buff.write(_struct_I.pack(length))
      for val1 in self.at_end_comparison:
        _x = val1.comparison_type
        buff.write(_get_struct_B().pack(_x))
        _v16 = val1.LHS
        ...
        _x = val1.grounded
        buff.write(_get_struct_B().pack(_x))
      length = len(self.over_all_comparison)
      buff.write(_struct_I.pack(length))
      for val1 in self.over_all_comparison:
        _x = val1.comparison_type
        buff.write(_get_struct_B().pack(_x))
        _v20 = val1.LHS
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if self.at_start_assign_effects is None:
        self.at_start_assign_effects = None
      if self.at_end_assign_effects is None:
        self.at_end_assign_effects = None
      if self.probabilistic_effects is None:
      ...
      if self.at_start_comparison is None:
        self.at_start_comparison = None
      if self.at_end_comparison is None:
        self.at_end_comparison = None
      if self.over_all_comparison is None:
        self.over_all_comparison = None
      end = 0
      start = end
      end += 4
      ...
      if python3:
        self.formula.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        self.at_start_assign_effects.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.at_end_assign_effects = []
      for i in range(0, length):
        ...
        (val1.grounded,) = _get_struct_B().unpack(str[start:end])
        val1.grounded = bool(val1.grounded)
        self.at_end_assign_effects.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.probabilistic_effects = []
      for i in range(0, length):
        ...
        self.probabilistic_effects.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.at_start_simple_condition = []
      ...
      for i in range(0, length):
        ...
        (val1.grounded,) = _get_struct_B().unpack(str[start:end])
        val1.grounded = bool(val1.grounded)
        self.at_start_comparison.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.at_end_comparison = []
      for i in range(0, length):
        ...
        (val1.grounded,) = _get_struct_B().unpack(str[start:end])
        val1.grounded = bool(val1.grounded)
        self.at_end_comparison.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.over_all_comparison = []
      for i in range(0, length):
        ...
        (val1.grounded,) = _get_struct_B().unpack(str[start:end])
        val1.grounded = bool(val1.grounded)
        self.over_all_comparison.append(val1)
      return self
