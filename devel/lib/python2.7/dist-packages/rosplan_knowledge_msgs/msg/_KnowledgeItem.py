...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.instance_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.optimization = str[start:end].decode('utf-8', 'rosmsg')
      else:
