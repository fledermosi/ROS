...
"""autogenerated by genpy from rosplan_dispatch_msgs/PlanActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanActionResult(genpy.Message):
  _md5sum = "76b9f4272133e5928a8d54e9ce17a32a"
  _type = "rosplan_dispatch_msgs/PlanActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rosplan_dispatch_msgs/PlanResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = rosplan_dispatch_msgs.msg.PlanResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rosplan_dispatch_msgs.msg.PlanResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.result_status = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.result_status = str[start:end]
      return self
