...
class EsterelPlanNode(genpy.Message):
  _md5sum = "56c4d424c0ed136cc9c74dbcf89f9977"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2i().pack(_x.action.action_id, _x.action.plan_id))
      _x = self.action.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action.action_id, _x.action.plan_id,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
