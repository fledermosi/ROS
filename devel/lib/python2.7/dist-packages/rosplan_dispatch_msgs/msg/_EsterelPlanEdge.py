...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.source_ids))
      length = len(self.sink_ids)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.sink_ids))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.edge_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.source_ids = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.sink_ids = s.unpack(str[start:end])
      _x = self
      start = end
      end += 16
