...
"""autogenerated by genpy from rosplan_dispatch_msgs/NonBlockingDispatchActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class NonBlockingDispatchActionFeedback(genpy.Message):
  _md5sum = "921db2a2208639b9e4023cde00df0f98"
  _type = "rosplan_dispatch_msgs/NonBlockingDispatchActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rosplan_dispatch_msgs/NonBlockingDispatchFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NonBlockingDispatchActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rosplan_dispatch_msgs.msg.NonBlockingDispatchFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rosplan_dispatch_msgs.msg.NonBlockingDispatchFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3i().pack(_x.feedback.feedback.action_id, _x.feedback.feedback.plan_id, _x.feedback.feedback.status))
      length = len(self.feedback.feedback.information)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.feedback.information:
        _x = val1.key
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.feedback.action_id, _x.feedback.feedback.plan_id, _x.feedback.feedback.status,) = _get_struct_3i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.feedback.information = []
      for i in range(0, length):
        ...
        self.feedback.feedback.information.append(val1)
      return self
