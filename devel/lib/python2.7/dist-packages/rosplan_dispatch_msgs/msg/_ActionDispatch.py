...
class ActionDispatch(genpy.Message):
  _md5sum = "9d0c5c1ebcb48d5f31ecc568f41bc70b"
...
"""
  __slots__ = ['action_id','plan_id','name','parameters','duration','dispatch_time']
  _slot_types = ['int32','int32','string','diagnostic_msgs/KeyValue[]','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       action_id,plan_id,name,parameters,duration,dispatch_time
