...
"""autogenerated by genpy from rosplan_dispatch_msgs/NonBlockingDispatchActionResult.msg. Do not edit."""
import codecs
import sys
...
class NonBlockingDispatchActionResult(genpy.Message):
  _md5sum = "28adc64a33bb912694894eb99f48ad5b"
  _type = "rosplan_dispatch_msgs/NonBlockingDispatchActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rosplan_dispatch_msgs/NonBlockingDispatchResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NonBlockingDispatchActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rosplan_dispatch_msgs.msg.NonBlockingDispatchResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rosplan_dispatch_msgs.msg.NonBlockingDispatchResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.result.success, _x.result.goal_achieved))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.success, _x.result.goal_achieved,) = _get_struct_2B().unpack(str[start:end])
      self.result.success = bool(self.result.success)
      self.result.goal_achieved = bool(self.result.goal_achieved)
      return self
