...
class NonBlockingDispatchActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new NonBlockingDispatchFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NonBlockingDispatchFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NonBlockingDispatchActionFeedback(null);
    ...
    data.feedback = NonBlockingDispatchFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += NonBlockingDispatchFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static md5sum() {
    ...
    return '921db2a2208639b9e4023cde00df0f98';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NonBlockingDispatchActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = NonBlockingDispatchFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new NonBlockingDispatchFeedback()
    }
...
module.exports = NonBlockingDispatchActionFeedback;
