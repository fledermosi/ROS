...
if("TRUE" STREQUAL "TRUE")
  set(rosplan_interface_movebase_SOURCE_PREFIX /home/lukas/catkin_ws/src/rosplan_demos/rosplan_demos_interfaces/rosplan_interface_movebase)
  set(rosplan_interface_movebase_DEVEL_PREFIX /home/lukas/catkin_ws/devel)
  ...
  set(rosplan_interface_movebase_INSTALL_PREFIX /home/lukas/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosplan_interface_movebase' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lukas/catkin_ws/src/rosplan_demos/rosplan_demos_interfaces/rosplan_interface_movebase/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosplan_interface_movebase_NUM_DUMMY_TARGETS)
      set(rosplan_interface_movebase_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosplan_interface_movebase::wrapped-linker-option${rosplan_interface_movebase_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosplan_interface_movebase_NUM_DUMMY_TARGETS "${rosplan_interface_movebase_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosplan_interface_movebase::wrapped-linker-option${rosplan_interface_movebase_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosplan_interface_movebase_LIBRARIES "${interface_target_name}")
